...
function Map.draw()
    local char_x, char_y = SmoothLocations.get_location(Character.ent_id) -- TODO pass character location around instead of getting it globally all over the place?
